...
const Regions = () => {
  const regions = [
    {key:'1', name: 'Dar Es Salaam', image: beirut},{key:'2', name: 'Arusha', image: Jounieh},{key:'3', name: 'Dodoma', image: Chouf},{key:'4', name: 'Mbeya', image: Batroun},
    {key:'5', name: 'Mwanza', image: keserwen},{key:'6', name: 'Tanga', image: Byblos},{key:'7', name: 'Zanzibar', image: tyre},{key:'8', name: 'Mafia', image: Batroun},{ key:'9', name: 'Kilimanjaro', image: Jounieh},
  ];
