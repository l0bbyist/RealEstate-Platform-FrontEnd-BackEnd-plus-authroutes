  ...
  return (
    <div className='md:flex md:gap-40'>
      <div className="text-lg text-gray-800 font-medium leading-9 max-w-2xl md:ml-20">
        <h2 className="text-3xl text-gray-800 font-medium leading-9">Property Purchase Requests</h2>
      ...
      <div className='mt-10 md:mt-0'>
        <h2 className="text-3xl text-gray-800 font-medium leading-9"> Details & Confirm Request</h2>
        <div className="w-36 h-1.5 bg-gradient-to-r from-primary to-black mb-5 mt-3"></div>
        <Meetings />
      </div>
